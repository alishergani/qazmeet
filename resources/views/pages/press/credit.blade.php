			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div class="credit-app">
						...
						<p class="subheading">Заполните заявку аккредитции для участия на форуме. <br>После обработки данных с Вами свяжется персональный менеджер.</p>
						...
						<div class="rules">
							...
							<div class="rules-wrapper">
								...
								<p class="item">4. Лица, не являющиеся представителями СМИ, а также представители рекламных изданий, каталогов или интернет-порталов коммерческой направленности не имеют права на аккредитацию СМИ., а также представители рекламных изданий, каталогов или интернет-порталов коммерческой направленности не имеют права на аккредитацию СМИ.</p>
							</div>
						</div>
					</div>
				</div>
